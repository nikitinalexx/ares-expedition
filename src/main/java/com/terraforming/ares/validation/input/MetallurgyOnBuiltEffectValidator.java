...
import com.terraforming.ares.cards.green.Metallurgy;
...
public class MetallurgyOnBuiltEffectValidator implements OnBuiltEffectValidator<Metallurgy> {
    private final OnBuiltEffectValidationService onBuiltEffectValidationService;

    @Override
    public Class<Metallurgy> getType() {
        return Metallurgy.class;
    }
