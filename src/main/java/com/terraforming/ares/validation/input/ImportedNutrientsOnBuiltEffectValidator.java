...
import com.terraforming.ares.cards.red.ImportedNutrients;
...
public class ImportedNutrientsOnBuiltEffectValidator implements OnBuiltEffectValidator<ImportedNutrients> {
    private static final String INCORRECT_INPUT_ERROR_MESSAGE =
            "Imported Nutrients requires input for Microbes";
    private final CardService cardService;

    @Override
    public Class<ImportedNutrients> getType() {
        return ImportedNutrients.class;
    }
