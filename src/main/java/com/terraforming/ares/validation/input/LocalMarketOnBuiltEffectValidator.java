...
import com.terraforming.ares.cards.green.LocalMarket;
...
public class LocalMarketOnBuiltEffectValidator implements OnBuiltEffectValidator<LocalMarket> {
    private static final String INCORRECT_INPUT_ERROR_MESSAGE =
            "Local Market: requires an input with the tag";

    @Override
    public Class<LocalMarket> getType() {
        return LocalMarket.class;
    }
