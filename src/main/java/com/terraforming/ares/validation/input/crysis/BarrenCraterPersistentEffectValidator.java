...
import com.terraforming.ares.cards.crysis.BarrenCrater;
 ...
 */
@Component
public class BarrenCraterPersistentEffectValidator implements PersistentEffectValidator<BarrenCrater> {
    private static final String ERROR_MESSAGE = "Barren Crater expects input with Ocean or Temperature";

    @Override
    public Class<BarrenCrater> getType() {
        return BarrenCrater.class;
    }
