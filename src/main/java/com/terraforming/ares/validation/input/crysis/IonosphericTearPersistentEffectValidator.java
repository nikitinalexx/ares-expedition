 ...
 */
@Component
public class IonosphericTearPersistentEffectValidator implements PersistentEffectValidator<IonosphericTear> {
    private static final String ERROR_MESSAGE = "Ionospheric Tear expects input with Ocean or Oxygen";

    @Override
    public Class<IonosphericTear> getType() {
        return IonosphericTear.class;
    }
