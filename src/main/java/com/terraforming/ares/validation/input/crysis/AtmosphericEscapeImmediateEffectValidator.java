 ...
 */
@Component
public class AtmosphericEscapeImmediateEffectValidator implements ImmediateEffectValidator<AtmosphericEscape> {
    private static final String ERROR_MESSAGE = "Atmospheric Escape expects input with choice of Hear or Plants";
