...
import com.terraforming.ares.cards.green.Exosuits;
...
public class ExosuitsOnBuiltEffectValidator implements OnBuiltEffectValidator<Exosuits> {
    private final OnBuiltEffectValidationService onBuiltEffectValidationService;

    @Override
    public Class<Exosuits> getType() {
        return Exosuits.class;
    }
