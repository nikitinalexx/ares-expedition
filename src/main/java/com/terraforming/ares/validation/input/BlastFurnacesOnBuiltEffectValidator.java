...
import com.terraforming.ares.cards.green.BlastFurnaces;
...
public class BlastFurnacesOnBuiltEffectValidator implements OnBuiltEffectValidator<BlastFurnaces> {
    private final OnBuiltEffectValidationService onBuiltEffectValidationService;

    @Override
    public Class<BlastFurnaces> getType() {
        return BlastFurnaces.class;
    }
