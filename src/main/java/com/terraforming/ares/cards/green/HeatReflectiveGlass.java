...
@Getter
public class HeatReflectiveGlass implements DiscoveryExpansionGreenCard {
    private final int id;
    private final CardMetadata cardMetadata;

    public HeatReflectiveGlass(int id) {
        this.id = id;
        this.cardMetadata = CardMetadata.builder()
                .name("Heat Reflective Glass")
                .description("Upgrade a phase card. During the production phase, this produces 1 heat.")
