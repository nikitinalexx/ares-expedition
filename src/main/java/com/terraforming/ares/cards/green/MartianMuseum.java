...
@Getter
public class MartianMuseum implements DiscoveryExpansionGreenCard {
    private final int id;
    private final CardMetadata cardMetadata;

    public MartianMuseum(int id) {
        this.id = id;
        this.cardMetadata = CardMetadata.builder()
                .name("Martian Museum")
                .description("Upgrade a phase card. During the production phase, this produces 1 MC.")
                .cardAction(CardAction.UPDATE_PHASE_CARD)
                .incomes(List.of(Gain.of(GainType.MC, 1)))
                .build();
    }
