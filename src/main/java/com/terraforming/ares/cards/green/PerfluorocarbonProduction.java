...
@Getter
public class PerfluorocarbonProduction implements DiscoveryExpansionGreenCard {
    private final int id;
    private final CardMetadata cardMetadata;

    public PerfluorocarbonProduction(int id) {
        this.id = id;
        this.cardMetadata = CardMetadata.builder()
                .name("Perfluorocarbon Production")
                .description("Upgrade your phase 1 card. Effect: During the production phase this produces 1 heat.")
                .cardAction(CardAction.UPDATE_PHASE_1_CARD)
