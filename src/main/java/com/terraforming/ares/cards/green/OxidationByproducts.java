...
@Getter
public class OxidationByproducts implements DiscoveryExpansionGreenCard {
    private final int id;
    private final CardMetadata cardMetadata;

    public OxidationByproducts(int id) {
        this.id = id;
        this.cardMetadata = CardMetadata.builder()
                .name("Oxidation Byproducts")
                .description("Upgrade a phase card. During the production phase, this produces 2 руфе.")
