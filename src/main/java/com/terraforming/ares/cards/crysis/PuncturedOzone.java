 ...
 */
public class PuncturedOzone implements CrysisCard {

    @Getter
    private final int id;

    public PuncturedOzone(int id) {
        this.id = id;
    }
    ...
    public String immediateEffect() {
        return "Decrease the oxygen 2 steps. Decrease the temperature 1 step. " +
