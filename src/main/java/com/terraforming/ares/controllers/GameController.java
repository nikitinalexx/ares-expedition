...
public class GameController {
    ...
    private void write(MarsGameRow row, PrintWriter pw) {
        ...
        pw.print(',');
//        pw.print(row.getSpace());
//        pw.print(',');
//        pw.print(row.getEarth());
//        pw.print(',');
//        pw.print(row.getEvent());
//        pw.print(',');
//        pw.print(row.getScience());
//        pw.print(',');
//        pw.print(row.getPlant());
//        pw.print(',');
//        pw.print(row.getEnergy());
//        pw.print(',');
//        pw.print(row.getBuilding());
//        pw.print(',');
//        pw.print(row.getAnimal());
//        pw.print(',');
//        pw.print(row.getJupiter());
//        pw.print(',');
//        pw.print(row.getMicrobe());
//        pw.print(',');
