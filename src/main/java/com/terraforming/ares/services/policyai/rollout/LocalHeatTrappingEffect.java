...
public class LocalHeatTrappingEffect extends AbstractTagEffect {

    private final List<Integer> putResource;
    private final CardService cardService;
    private final Player player;

    public LocalHeatTrappingEffect(Map<Integer, List<Integer>> params, CardService cardService, Player player) {
