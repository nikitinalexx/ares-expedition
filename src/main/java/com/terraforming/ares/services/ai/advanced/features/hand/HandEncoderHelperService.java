...
public class HandEncoderHelperService {
    ...
    public float countMilestoneProgressByHand(Milestone milestone, List<Card> hand, int[] handTagCounts, Map<GainType, Stats> gainTypeToCounts, Map<GainType, Stats> incomeTypeToCounts) {
        float result = 0;
    ...
    public float countAwardProgressByHand(BaseAward baseAward, List<Card> hand, int[] handTagCounts) {
    ...
    private int extractTotalIncome(List<Card> hand, Set<GainType> gainType) {
    ...
    private int countCardsWithRequirements(List<Card> cards) {
        int count = 0;
        for (Card card : cards) {
